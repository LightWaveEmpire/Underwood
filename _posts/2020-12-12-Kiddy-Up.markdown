...
Kiddy-Up utilizes Docker, Django, and SpaCy to build and do the nessecary parsing of data. The following is a walkthrough of the basic use and functionality of Kiddy-Up
